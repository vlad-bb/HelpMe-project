...
def start(folder: Path):
    ...
    for file in parser.DOC_DOCUMENTS:
        handle_data(file, folder / 'documents' / 'DOC')
    for file in parser.DOCX_DOCUMENTS:
        handle_data(file, folder / 'documents' / 'DOCX')
    for file in parser.TXT_DOCUMENTS:
        handle_data(file, folder / 'documents' / 'TXT')
    for file in parser.PDF_DOCUMENTS:
        handle_data(file, folder / 'documents' / 'PDF')
    for file in parser.XLSX_DOCUMENTS:
        handle_data(file, folder / 'documents' / 'XLSX')
    for file in parser.PPTX_DOCUMENTS:
        handle_data(file, folder / 'documents' / 'PPTX')
